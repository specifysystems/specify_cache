...
def resolver_get(occid=None, provider=None):
    ...
    Args:
        occid (str): An occurrenceID, a DarwinCore field intended for a globally 
    ...
    """
    occurrence_id = request.args.get(OCCURRENCE_ID_QUERY_PARAM, type=str, default=None)
